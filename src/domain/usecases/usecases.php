...
require_once(__DIR__ . '/Product/AddProductModel.php');
...
require_once(__DIR__ . '/AddTaxModel.php');
require_once(__DIR__ . '/AddProductTypeTax.php');
require_once(__DIR__ . '/AddProductTypeTaxModel.php');